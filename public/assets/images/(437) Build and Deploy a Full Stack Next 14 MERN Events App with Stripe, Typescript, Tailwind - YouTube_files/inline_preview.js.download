(function(g){var window=this;'use strict';var hrb=function(a){g.U.call(this,{I:"div",S:"ytp-inline-preview-ui"});this.gg=!1;this.player=a;this.T(a,"onStateChange",this.MR);this.T(a,"videodatachange",this.vx);this.T(a,"onInlinePreviewModeChange",this.m7);this.Yg=new g.Cu(this.EE,null,this);g.J(this,this.Yg)},H6=function(a){g.RV.call(this,a);
this.j=new hrb(this.player);g.J(this,this.j);this.j.hide();g.GU(this.player,this.j.element,4);a.isInline()&&(this.load(),a=a.getRootNode(),g.Nu(a,["ytp-inline-preview-mode","ytp-no-contextmenu"]))};
g.w(hrb,g.U);g.k=hrb.prototype;
